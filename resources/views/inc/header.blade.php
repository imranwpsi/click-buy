        ...
        <div class="clearfix row">
                  ...
                  <div class="b-main_menu menu-stay-left">
                      <ul class="categories pl-0 mb-0 list-unstyled">
                          ...
                          <li class=" b-has_sub b-dropdown_wrapper from-bottom">
                            ...
                            <span class="top"><i class="fa fa-home"></i> Home</span></a>
                          </li>
                          <!-- Top level items -->
                          <li class=" b-has_sub b-dropdown_wrapper from-bottom">
                                                      ...
                                                      <div class="row">
                                                          <div class="col-sm-12 hover-menu">
                                                              <ul>
                                                                ...
                                                                <li><a href="#">With logo center</a></li>
                                                                <li><a href="#">Categories menu HOT</a></li> 
                                                                <li><a href="#">Top bar menu</a></li> 
                          ...
                          <li class="b-has_sub b-dropdown_wrapper from-bottom">
                              <a href="#"><span class="top">FEATURES</span></a>
                           </li>   
                      </ul>
                  </div>
              </div> 
          ...
          <div class="col-xl-4 col-lg-4 col-mb-4 col-sm-4 col-xs-6">
            <div class="b-logo text-sm-left text-lg-center text-xl-center">
              <a href="index.html" class="d-inline-block"><img src="assets/img/logo.png" class="img-fluid d-block" alt=""></a>
            </div>
          </div>
